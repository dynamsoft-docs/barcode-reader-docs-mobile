...
* [Samples](samples/index.md)
  * HelloWorld
    ...
    * <a data-balloon-length="xlarge" data-balloon-pos="down" aria-label="The simplest code to run a video streaming barcode scanner with AVCaptureSession powered camera module." class="button title" href="samples/no-camera-enhancer.html">Decode with AVCaptureSession</a>

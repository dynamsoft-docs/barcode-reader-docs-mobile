...
title: Parameters, Settings & Templates - Dynamsoft Barcode Reader iOS
description: Learn how parameters, simplified settings, and templates work in Dynamsoft Barcode Reader iOS SDK.
keywords: parameters, settings, templates, iOS, objective-c, swift
noTitleIndex: true
...
- [`SimplifiedCaptureVisionSettings`]({{ site.dcvb_ios_api }}capture-vision-router/simplified-capture-vision-settings.html) API references
- How to use customized templates - [initSettingsFromFile]({{ site.dcvb_ios_api }}capture-vision-router/settings.html#initsettingsfromfile)

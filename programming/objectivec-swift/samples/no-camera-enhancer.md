...
- <a href="https://github.com/Dynamsoft/barcode-reader-mobile-samples/tree/v9.6.20/ios/Objective-C/DecodeWithAVCaptureSession/" target="_blank">Objective-C Decode with AVCaptureSession Sample (v9.6.20)</a>
- <a href="https://github.com/Dynamsoft/barcode-reader-mobile-samples/tree/v9.6.20/ios/Swift/DecodeWithAVCaptureSession/" target="_blank">Swift Decode with AVCaptureSession Sample (v9.6.20)</a>

...
- View Enum [`BarcodeFormat`]({{ site.mobile-enum }}barcode-format.html?lang=objc,swift) and [`BarcodeFormat_2`]({{ site.mobile-enum }}barcode-format2.html?lang=objc,swift) to learn about all available barcode formats.

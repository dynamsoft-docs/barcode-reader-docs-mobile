...
- You can view the enumeration [`BarcodeFormat`]({{ site.dcv_enumerations }}barcode-reader/barcode-format.html?lang=objc,swift) for all the supported barcode formats.

...
title: DeblurMode - Dynamsoft Barcode Reader iOS Enumerations
description: The enumeration DeblurMode of Dynamsoft Barcode Reader iOS describes deblur modes that implemented on the localized barcodes.

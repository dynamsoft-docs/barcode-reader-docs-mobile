...
permalink: /programming/objectivec-swift/api-reference/primary-decode-v9.6.20.html
---
...
> View sample <a href="https://github.com/Dynamsoft/barcode-reader-mobile-samples/tree/v9.6.20/ios/Swift/DecodeWithAVCaptureSession" target="_blank">`DecodeWithAVCaptureSession`</a> to see how to process the video streaming.

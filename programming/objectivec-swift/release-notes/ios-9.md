...
- Added a new method [`minImageReadingInterval`]({{ site.oc_api }}primary-video.html#minimagereadinginterval) to set a minimum interval between consecutive barcode decoding processes.

...
- <a href="https://github.com/Dynamsoft/barcode-reader-mobile-samples/tree/v9.6.20/android/Java/GeneralSettings" target="_blank">Android (Java) General Settings Sample</a>

...
description: This guide covers the basic settings for Dynamsoft Barcode Reader project for java (Andriod). Find out how to add basic runtime settings to the Barcode Reader project.

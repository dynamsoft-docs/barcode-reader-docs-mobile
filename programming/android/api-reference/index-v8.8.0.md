...
### Result
  ...
  | [`enableResultVerification`](primary-result.html#enableresultverification) | Verify the results before output. |
  | [`enableDuplicateFiter`](primary-result.html#enableduplicatefiter) | Output the duplicated result only once for every 3 seconds. |

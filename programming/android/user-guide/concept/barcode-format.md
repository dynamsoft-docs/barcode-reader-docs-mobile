...
description: Learn how barcode format configuration affects performance and accuracy in the Dynamsoft Barcode Reader Android SDK.
...
- [How to Configure Barcode Formats]({{ site.android }}user-guide/capabilities/barcode-formats.html)
